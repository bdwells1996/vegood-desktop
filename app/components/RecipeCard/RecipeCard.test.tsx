...
import type { DietaryTag, AllergenTag } from './RecipeCard';
...
describe('RecipeCard Component', () => {
	...
	describe('Rendering', () => {
		...
		it('should render the article with aria-label', () => {
			...
			expect(article).toHaveAttribute('aria-label', 'Creamy Garlic Pesto Pasta');
		});
	});
	...
	describe('Image', () => {
		it('should render image with correct src and alt', () => {
			...
			expect(image).toHaveAttribute('alt', 'A bowl of creamy garlic pesto pasta');
		});
	});
	...
	describe('Layout', () => {
		it('should have fixed dimensions', () => {
			const { container } = render(<RecipeCard {...defaultProps} />);
			const article = container.querySelector('article');
			expect(article).toHaveClass('w-[282.664px]', 'h-[419px]');
		});
